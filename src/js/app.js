...
function downloadPromptsAsFile(type = 'complete') {
    ...
    if (type === 'image') {
        ...
        successLog(`💾 Downloaded ${AppState.processedImages.length} image prompts`);
        ...
        successLog(`💾 Downloaded ${AppState.processedImages.length} video prompts`);
        ...
        successLog(`💾 Downloaded complete export with ${AppState.processedImages.length} results`);
    }
...
function updateExportStats() {
    ...
    elements.exportStatsContent.innerHTML = `
        ...
        📋 <strong>${totalPrompts}</strong> total prompts ready for export<br><br>
        💡 <strong>Export Options:</strong><br>
        • Individual TXT files with simple newline format<br>
        • Complete detailed export with descriptions
    `;
}
